...
\begin{itemize}
    ...
    \item \textbf{2-MG Deficit (Long Fault - Temporal Depth):} The system-wide outage is extended to an 11-hour window ($t=9$ to $t=19$). Since the MPC algorithm exhibits conservative Battery Energy Storage System (BESS) hoarding (a recognized algorithmic limitation established in Section 6.2.4), this prolonged scenario specifically tests the continuous endurance of the P2P active power routing network rather than local battery capacities.
