...
\node (mode2) [process, below=of decision, yshift=-0.5cm] {\textbf{Mode 2}\\(Emergency, $h=5$)\\\textit{Activate Constraints}\\\textit{Call Spatial ATC}};
...
To enforce Graceful Degradation, load shedding is decoupled into normal and critical loads with hierarchical VOLL coefficients, and simultaneously, a terminal SOC penalty ($J_{SOC}$) is activated. 
