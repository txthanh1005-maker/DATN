...
\begin{figure}[H]
    ...
    \caption{Internal configuration of a typical Microgrid node. Source: Modern clean energy microgrid diagram. Image by AllahFoto, licensed via Adobe Stock (Education License).}
