...
\end{equation}
This equality constraint is highly non-convex. To achieve a computationally tractable convex model, SOC inequality constraint. The SOC relaxation transforms the non-convex feasible region into a convex cone by replacing the equality with an inequality:
\begin{equation}
