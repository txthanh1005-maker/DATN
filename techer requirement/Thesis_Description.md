...
2. **Privacy and Structural Vulnerabilities:** Centralized Energy Management Systems (EMS) pose data privacy risks and act as a single point of failure during extreme weather events. Conversely, standard flat distributed algorithms (like ADMM) suffer from structural gradient conflicts and diverge when applied to complex, non-linear hierarchical AC-OPF problems.
