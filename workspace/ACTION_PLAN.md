...
- [x] DONE: Củng cố lập luận (Task 7 & 8 - HIGH): Viết tiểu mục "Conclusion/Discussion" ở cuối *từng chương* (Chương 1, 2, 3, 4). Mở rộng "General Conclusion". (Assigned: `latex_writer`)
